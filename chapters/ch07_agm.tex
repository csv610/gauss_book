...
The arithmetic-geometric mean (AGM) is one of Gauss's most beautiful discoveries. Given two positive numbers $a_0$ and $b_0$, define sequences
\[
a_{n+1} = \frac{a_n + b_n}{2}, \quad b_{n+1} = \sqrt{a_n b_n}.
\]
These sequences converge to a common limit $M(a_0, b_0)$, the arithmetic-geometric mean. Gauss discovered that $M(1, \sqrt{2})$ relates to the lemniscate constant and elliptic integrals.

In this chapter, we cover:
\begin{itemize}
    \item Definition and basic properties of the AGM
    \item Connection to complete elliptic integrals
    \item Gauss's constant and the lemniscate
...
\begin{exercise}
Derive the relation between the AGM and the hypergeometric function:
